...
/*GENERATED_CODE_START*/
		...
		public:
			...
			ClassPropertiesInfos getClassPropertiesInfos() override { return ClassPropertiesInfos(std::vector{zt::core::reflection::ClassPropertyInfo{offsetof(AssetTexture, i1), "i1", "int"},
